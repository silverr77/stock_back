...
class FactureFournisseurDataPersister implements ContextAwareDataPersisterInterface {
    ...
    {
        return $data instanceof FactureCommandeFournisseurs;
    }
    ...
    public function persist($data, array $context = [])
    {
        ...
        $factures = $commande->getFactureCommandeFournisseurs()->getValues();
